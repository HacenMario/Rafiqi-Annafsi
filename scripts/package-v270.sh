#!/bin/bash
# Package Rafiqi Annafsi v2.7.0 — full source (no node_modules/.env/build artifacts)
set -e
SRC=/home/z/my-project
STG=$SRC/scripts/staging-v270
ROOT="$STG/Rafiqi-Annafsi-main"
OUT=$SRC/download/Rafiqi-Annafsi-v2.7.0.zip
...
# ─── الملفات والمجلدات المضمّنة (نفس بنية v2.5.5 + ملفات v2.7.0 الجديدة) ───
rsync -a \
